...
export default class BottomSheetBehavior extends React.Component<Props, State> {
  ...
  private withEnhancedLimits(
    ...
    return block([
      Animated.debug('clockForOverscroll is running', clockRunning(clockForOverscroll)),
      cond(
    ...
    return (
      <>
        ...
        <Animated.View
          ...
          <View style={[styles.container, { height: this.state.initSnap }]}>
            <PanGestureHandler
              ref={this.panRef}
