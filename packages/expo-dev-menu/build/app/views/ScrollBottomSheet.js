...
let ScrollBottomSheet = /** @class */ (() => {
    class ScrollBottomSheet extends Component {
        constructor(props) {
            super(props);
            /**
        ...
        render() {
            const { renderHandle, snapPoints, initialSnapIndex, componentType, onSettle, animatedPosition, containerStyle, children, ...rest } = this.props;
            ...
            const renderScreen = screen => {
                ...
                return (React.createElement(Stack.Screen, { key: screen.name, name: screen.name, options: screen.options }, props => {
                    return (React.createElement(NativeViewGestureHandler, { ref: this.scrollComponentRef, waitFor: this.masterDrawer, simultaneousHandlers: this.drawerContentRef },
            ...
            const Content = (React.createElement(Animated.View, { style: [
                ...
                React.createElement(PanGestureHandler, { ref: this.drawerContentRef, simultaneousHandlers: [this.scrollComponentRef, this.masterDrawer], shouldCancelWhenOutside: false, onGestureEvent: this.onDrawerGestureEvent, onHandlerStateChange: this.onDrawerGestureEvent },
                    React.createElement(Animated.View, { style: styles.container },
                        React.createElement(Stack.Navigator, { initialRouteName: "Main", headerMode: "float" }, this.props.screens.map(renderScreen)))),
    ...
    return ScrollBottomSheet;
})();
export { ScrollBottomSheet };
...
//# sourceMappingURL=ScrollBottomSheet.js.map