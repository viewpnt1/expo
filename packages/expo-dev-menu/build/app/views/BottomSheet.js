            ...
            return (React.createElement(React.Fragment, null,
                ...
                React.createElement(Animated.View, { style: {
                    ...
                    React.createElement(View, { style: this.props.enabledInnerScrolling && {
                        ...
                        React.createElement(PanGestureHandler, { enabled: this.props.enabledGestureInteraction && this.props.enabledContentGestureInteraction, waitFor: this.master, ref: this.panRef, onGestureEvent: this.handlePan, onHandlerStateChange: this.handlePan, simultaneousHandlers: this.props.simultaneousHandlers },
                            React.createElement(Animated.View, null,
                                React.createElement(Animated.View, { style: styles.headerContainer, onLayout: this.handleLayoutHeader }, this.props.renderHeader?.()),
                        ...
                        (this.props.onOpenStart || this.props.onCloseEnd) && (React.createElement(Animated.Code, { exec: onChange(this.translateMaster, [
                                cond(and(lessOrEq(divide(this.translateMaster, this.state.snapPoints[this.state.snapPoints.length - 1]), 1 - (this.props.callbackThreshold ? this.props.callbackThreshold : 0.01)), neq(this.onOpenStartValue, 1)), [
                                    call([], () => {
                        ...
                        (this.props.onOpenEnd || this.props.onCloseStart) && (React.createElement(Animated.Code, { exec: onChange(this.translateMaster, [
                                cond(and(lessOrEq(divide(this.translateMaster, this.state.snapPoints[this.state.snapPoints.length - 1]), this.props.callbackThreshold ? this.props.callbackThreshold : 0.01), neq(this.onOpenEndValue, 1)), [
                                    call([], () => {
                        ...
                        (this.props.onCloseStart || this.props.onOpenEnd) && (React.createElement(Animated.Code, { exec: onChange(this.translateMaster, [
                                cond(and(greaterOrEq(divide(this.translateMaster, this.state.snapPoints[this.state.snapPoints.length - 1]), this.props.callbackThreshold ? this.props.callbackThreshold : 0.01), neq(this.onCloseStartValue, 1)), [
                                    call([], () => {
                        ...
                        (this.props.onCloseEnd || this.props.onOpenStart) && (React.createElement(Animated.Code, { exec: onChange(this.translateMaster, [
                                cond(and(greaterOrEq(divide(this.translateMaster, this.state.snapPoints[this.state.snapPoints.length - 1]), 1 - (this.props.callbackThreshold ? this.props.callbackThreshold : 0.01)), neq(this.onCloseEndValue, 1)), [
                                    call([], () => {
